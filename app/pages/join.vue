    ...
    >
      ...
      <template #default>
        <p class="mb-4 text-gray-700">
          我們正在徵求各組長期志工，誠摯邀請您加入我們的行列。請詳閱以下參與條件：
        </p>

        <ul class="mb-4 list-disc pl-5">
          <li class="mb-3 text-gray-700">
            您為大專院校（含）以下學生，年齡不超過25歲（25歲以上僅可擔任顧問職務）
          </li>
          <li class="mb-3 text-gray-700">
            您能長期擔任職務，並保證有充裕時間參與線上或線下會議
          </li>
          <li class="mb-3 text-gray-700">
            您認同本團體理念，願與我們一起推動青年聲音
          </li>
        </ul>
